...
public class TipView extends FrameLayout {
	 ...
	 * 动画间隔
	 */
	private static final int ANIM_DELAYED_MILLIONS = 1500;//2 * 1000;
	/**
	 * 动画持续时长
	 */
	private static final int ANIM_DURATION = 1500;//2 * 1000;
	/**
	 * 默认字体颜色
	 */
	...
	private TextView newTextView() {
		...
		FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER_VERTICAL);
