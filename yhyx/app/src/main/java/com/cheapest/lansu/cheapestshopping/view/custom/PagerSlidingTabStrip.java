...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int selectedTabTextColor = 0xFFFF3B21;  //选中Tab的颜色0xFFff560b
	private int unSelectedTabTextColor = 0x000000;    //未选中Tab的颜色
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		unSelectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_unSelectedTabTextColor, unSelectedTabTextColor);
...
//					tab.setTextColor(0xFFFF3B21);
//					tab.setTextSize(tabTextSize);
					tab.setTextColor(selectedTabTextColor);
				} else {
					tab.setTextColor(unSelectedTabTextColor);
				}
			}
		}
